    ...
    <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6 max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="titleInput" className="block text-sm font-bold text-slate-700 mb-1">제목</label>
            <input 
              id="titleInput"
          ...
          <div>
            <label htmlFor="stepInput" className="block text-sm font-bold text-slate-700 mb-1">가치사슬 단계</label>
            <select 
              id="stepInput"
        ...
        <div>
           <label htmlFor="majorsInput" className="block text-sm font-bold text-slate-700 mb-1">관련 전공 (쉼표 , 로 구분)</label>
           <input 
              id="majorsInput"
        ...
        <div>
           <label htmlFor="keywordsInput" className="block text-sm font-bold text-slate-700 mb-1">키워드 (쉼표 , 로 구분)</label>
           <input 
              id="keywordsInput"
        ...
        <div>
          <label htmlFor="contentInput" className="block text-sm font-bold text-slate-700 mb-1">본문 (Markdown)</label>
          <textarea 
            id="contentInput"
